...
public class TextLineNumber extends JPanel
    ...
    private Font myFont = new Font("Consolas",0,14);
    ...
    public TextLineNumber(JTextComponent component, int minimumDisplayDigits) {
        ...
        myFont = new Font("Consolas",0,component.getFont().getSize());
        setFont(myFont);
        setBorderGap(5);
    ...
    public void paintComponent(Graphics g) {
        ...
        FontMetrics fontMetrics = component.getFontMetrics(myFont);
        Insets insets = getInsets();
